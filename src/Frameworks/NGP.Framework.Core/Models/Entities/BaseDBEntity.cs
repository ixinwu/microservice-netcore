...
namespace NGP.Framework.Core
{
    ...
    public abstract class BaseDBEntity : BaseEntity
    {
        ...
        /// 创建平台
        /// </summary>
        public virtual string CreatedCompany { get; set; }
        /// <summary>
        /// 创建区域
        /// </summary>
        public virtual string CreatedArea { get; set; }
        /// <summary>
        /// 更新时间
        /// </summary>
        ...
        /// 更新平台
        /// </summary>
        public virtual string UpdatedCompany { get; set; }
        /// <summary>
        /// 更新区域
        /// </summary>
        public virtual string UpdatedArea { get; set; }
        /// <summary>
        /// 排序字段
        /// </summary>
