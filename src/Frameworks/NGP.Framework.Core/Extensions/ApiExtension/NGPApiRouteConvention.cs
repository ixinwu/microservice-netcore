 ...
 * 
 * NGPApiRouteConvention Description:
 * ngp路由约定
 *
 * Comment 					        Revision	Date        Author
 * -----------------------------    --------    --------    -----------
 * Created							1.0		    2019-8-15   hulei@ixinwu.com
 * Updated                          1.0         2019-8-31   hulei@ixinwu.com 
 *
 * ------------------------------------------------------------------------------*/
...
namespace NGP.Framework.Core.Api
{
    /// <summary>
    /// ngp路由约定
    /// </summary>
    public class NGPApiRouteConvention : IApplicationModelConvention
    {
        /// <summary>
        /// 前缀
        /// </summary>
        ...
        public NGPApiRouteConvention(string prefix, Func<ControllerModel, bool> controllerSelector)
        {
            this.prefix = prefix;
