 ...
 * -----------------------------    --------         --------            -----------
 * Created							1.0		    2019/3/4 15:37:45   rock@xcloudbiz.com
 *
 * ------------------------------------------------------------------------------*/
...
namespace NGP.Framework.DataAccess
{
    ...
    /// 服务运行配置映射
    /// </summary>
	public class SysConfig_ServiceRunningMap : BaseDBEntityMap<SysConfig_ServiceRunning>, INGPEntityMap
    {
        /// <summary>
        /// 服务运行配置映射
        /// </summary>
        /// <param name="builder"></param>
        protected override void PostConfigure(EntityTypeBuilder<SysConfig_ServiceRunning> builder)
        {
